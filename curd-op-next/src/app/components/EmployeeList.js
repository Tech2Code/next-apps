...
const EmployeeList = () => {
    const { getData, employees, filterSearch, deleteEmployee } = useContext(GlobalContext)
    ...
    return (
        employees.length > 0 ? (
            employees.map((employee) => (
                <div data-aos="fade-up" className="flex items-center bg-gray-100 mb-10 shadow" key={employee.id}>
